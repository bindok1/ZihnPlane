...
class _HomePageState extends State<HomePage> {
  @override
  void initState() {
    //init state dipanggil ketika halaman dibuka
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Howdy,\n${state.user.name}', //key untuk ubah user jadi dinamis
...
//tambahkan List<DestinationModel untuk membuat data menjadi dinamis
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            children: destination.map((DestinationModel destination) {
              return destiantionCard(destination);
            }).toList(),
          ),
        ),
      );
      ...
      return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children:
                    destination.map((DestinationModel destination) {
                  return DestiantionTile(destination);
                }).toList(),
              ),
            ],
          ));
